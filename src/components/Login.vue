  ...
  <div class="w-full max-w-md mx-auto">
    <div class="bg-white p-8 sm:p-10 rounded-2xl shadow-[0_4px_24px_rgba(0,0,0,0.02)] border border-slate-100">
      <div class="mb-8">
        ...
        <h2 class="text-center text-2xl font-bold text-slate-900 tracking-tight">Bonjour</h2>
      ...
      <form class="space-y-5" @submit.prevent="submit">
        ...
        <div class="text-center text-sm mt-6">
          <span class="text-slate-500">Nouveau sur SecureDrop ?</span>
          <router-link to="/register" class="ml-1.5 font-medium text-slate-900 hover:underline underline-offset-4 transition-all">Créer un compte</router-link>
        </div>
      </form>
    </div>
  </div>
